    ...
    public partial class mig7 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "Perfumes" },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, null, "Fragrances" }
                });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedDate", "CreatedId", "RoleName", "UpdatedDate", "UpdatedId" },
                values: new object[] { 1, new DateTime(2024, 11, 1, 13, 25, 27, 30, DateTimeKind.Utc).AddTicks(2163), 1, "Admin", new DateTime(2024, 11, 1, 13, 25, 27, 30, DateTimeKind.Utc).AddTicks(2166), 1 });
